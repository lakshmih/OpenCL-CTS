                                     ...
                                     int num_elements)
{
    ...
    SEMAPHORE_PARAM_TEST(CL_SEMAPHORE_EXPORT_HANDLE_TYPES_KHR, cl_uint, getCLSemaphoreTypeFromVulkanType(vkExternalSemaphoreHandleType));
